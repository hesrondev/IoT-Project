...
void Design::design(QWidget *wdg)
{
    QString qs = "";

    wdg->setStyleSheet(qs);
}


void Design::customDialogWidget(QWidget *bs)
{
...
void Design::customIndexView(QWidget *bs)
{
    QString qs = "QPushButton {"
...
void Design::customLoginView(QWidget *bs)
{
    QString qs = "QPushButton {"
                 "border-style: outset;"
...
void Design::customConfigModel(QWidget *bs)
{
...
void Design::customToolBar(QWidget *bs)
{
    QString qs = "QPushButton {"
                 "width:60px;"
                 "height:15px;"
...
void Design::customProgressBar(QWidget *bs)
{
...
void Design::customChallengeDesc(QWidget *bs)
{
...
void Design::customNotationWidget(QWidget *bs)
{
    QString qs = "QGroupBox {"
                 "border: 1px solid #ccc;"
                 "border-bottom-left-radius: 3px;"
...
void Design::customTdbWidget(QWidget *bs)
{
    QString qs = "QPushButton {"
                 "width:70px;"
                 "height:15px;"
...
void Design::customNotesUserWidget(QWidget *bs)
{
